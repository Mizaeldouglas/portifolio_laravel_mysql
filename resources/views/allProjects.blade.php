                ...
                @foreach ($projects as $project)
                    <div class="max-w-sm bg-gray-800 border border-gray-700 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transform transition-transform duration-300 hover:scale-105">
                        ...
                        <div class="p-5 flex flex-col">
                            ...
                            <p class="mb-3 font-normal text-gray-400 dark:text-gray-400 text-left">{{ $project->description }}</p>
                            <span class="mt-2 mb-5 text-sm text-gray-400 dark:text-gray-300">{{ $project->date }}</span>
                            <a href="#" class="mt-auto inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700t focus:ring-4 focus:outline-none focus:ring-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Saiba Mais
