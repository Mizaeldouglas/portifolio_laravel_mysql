        ...
        <div class="container px-6 py-10 mx-auto my-10">
            ...
            <div class="grid grid-cols-2 gap-8 mt-8 md:mt-16 md:grid-cols-3">
                @foreach ($projects as $project)
                    <div class="max-w-sm bg-gray-800 borderborder-gray-700 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transform transition-transform duration-300 hover:scale-105">
                        <a href="#">
                        ...
                        <div class="p-5 flex flex-col">
                            ...
                            <a href="#"
                               class="mt-5 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Saiba Mais
